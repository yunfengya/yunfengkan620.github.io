...
import cssItem018 from "./css001components/cssItem018";
import cssItem019 from "./css001components/cssItem019";
    ...
    data() {
        return {
            ...
            nameList: [
                ...
                { label: "涟漪动效", name: "cssItem018" },
                { label: "指令-懒加载(image和背景)", name: "cssItem019" },
            ],
        };
    },
    created() { },
